...
# Key ထုတ်ပြီး Variable ထဲထည့်ခြင်း (script အတွင်း run ရန် -i ကိုသာ အသုံးပြုထားသည်)
KEYS=$(docker exec -it marzban-marzban-1 xray x25519)
...
echo -e "\n${CYAN}*************************************************${NC}"
echo -e "${GREEN}🎉 အားလုံးပြီးစီးပါပြီ! Aung Kyaw ရဲ့ Marzban ကို ${YELLOW}http://$DOMAIN_NAME${GREEN} ဖြင့် ဝင်ရောက်အသုံးပြုနိုင်ပါပြီ။${NC}"
echo -e "${CYAN}*************************************************${NC}\n"
